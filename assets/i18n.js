...
(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    '版本：2026-09-21。现有 71 条有来源研究记录：43 个详细车档、27 条待核对线索、1 辆预生产车；9 个完整公开 VIN；381 条图库图片引用覆盖 60 条记录。历史继承条目与新增 VIN／dealer 车档均保留逐车来源和核对状态。': 'Version: 2026-09-21. The Atlas now contains 71 sourced research records: 43 detailed profiles, 27 leads, and 1 pre-production car; 9 complete public VINs; and 381 gallery image references across 60 records. Historical entries and the newly added VIN/dealer records retain per-car sources and review status.',
