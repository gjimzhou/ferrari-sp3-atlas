...
(() => {
  ...
  const exact = new Map(Object.entries({
    ...
    '一条档案计一次；含待核对线索，不含预生产车。此图不推断原始分配国家或车主居住地。': 'Each record is counted once; leads are included and pre-production cars are excluded. This chart does not infer original allocation country or owner residence.',
    ...
    '保存来源明确支持的配置或收藏关系。没有 VIN 的车档仍可能与索引重复。': 'Keep specifications or collection relationships directly supported by cited sources. Profiles without a VIN may still overlap with index entries.',
    ...
    '版本：2026-09-21。现有 83 条有来源研究记录：43 个详细车档、39 条待核对线索、1 辆预生产车；21 个完整公开 VIN；381 条图库图片引用覆盖 60 条记录。默认车辆页仍只显示详细车档；单源 VIN 只作为待核对 lead 保留。': 'Version: 2026-09-21. The Atlas now contains 83 sourced research records: 43 detailed profiles, 39 leads, and 1 pre-production car; 21 complete public VINs; and 381 gallery image references across 60 records. The default vehicle view still shows detailed profiles only; single-source VINs are retained as research leads.',
    ...
    '无 VIN 的档案可能与其他来源重复。公开地点不代表当前车主居住地。': 'Profiles without a VIN may duplicate other sources. A public location does not represent the current owner’s residence.',
