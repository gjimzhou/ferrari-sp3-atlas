...
(() => {
  ...
  const zhRecords = {
    ...
    "SP3-BP-GREEN":{
      title:"Green Jewel / BP Green — F1 车手签名 — 底盘 291269",
      edition:"原始 599 辆量产序列；Ferrari Atelier / Extra-Range 定制",
      city:"经 Charles Pozzi Paris 新车交付；后在迪拜挂牌",
      market:"欧洲规格 / 后续迪拜二手市场",
      owner:"私人车主",
      exterior:"四层 Extra-Range 绿色车漆，工厂代码 GREEN JEWEL FYM.181037(X1)；迪拜经销商／媒体将同一辆车称为一次性 BP Green",
      interior:"Alcantara Rosso FX 3694；Nero Alcantara 方向盘握把；Extra-Range 座舱细节",
      wheels:"金色锻造轮毂",
      calipers:"亮黑色",
      mileage:"Octane 挂牌记录 512 km；2024 Charles Pozzi 保养时 501 km。2025 迪拜报道则约为 629 km / 少于 400 miles，公开里程数据存在冲突。",
      status:"公开经销商市场车辆；此前由迪拜 F1rst Motors 挂牌",
      sale:"2025 迪拜挂牌阶段报道要价 AED 21,000,000",
      program:"Ferrari Atelier / Extra-Range",
      options:["发动机盖由 Charles Leclerc 与 Carlos Sainz Jr. 以金色签名","GREEN JEWEL FYM.181037(X1) 四层 Extra-Range 车漆","三圆形 Historic / Vintage 涂装","三个 Bianco Cervino 2005001 圆标，内部为 Nero DS 205500 的 16 号","气刷 Scuderia Ferrari 盾徽","亮黑色刹车卡钳","金色锻造轮毂","碳纤维硬顶","碳纤维车身下部","碳纤维后盖唇边","黑色四点式安全带","Apple CarPlay","前轴升降","黑色 Alcantara 门把手","头枕 Cavallino 使用特殊 70268 缝线","Alcantara Rosso FX 3694 内饰","Nero Alcantara 方向盘握把","大号座垫 / L32 靠背","Racing Driver Set","Extra-Range 外观、内饰与脚垫"],
      timeline:["2023 年 — 经 Charles Pozzi Paris 新车交付。","2024 年 — Charles Pozzi Paris 年度保养，记录 501 km。","2025 年 2 月 — F1rst Motors Dubai 与国际媒体挂牌这辆绿色 Daytona SP3，发动机盖有 Leclerc / Sainz 金色签名；报道要价 AED 21 million。","2026 年公开 Octane Marketplace 挂牌 — 发布 VIN ZFF05UMB000291269、512 km 及详细 Ferrari Atelier 配置单。"],
      notes:"本站旧记录没有 VIN。Octane Marketplace 现已公开 VIN ZFF05UMB000291269，并发布详细工厂个性化配置：Green Jewel 车漆、金色锻造轮毂以及发动机盖上的 Leclerc / Sainz 金色签名。这些高度独特的特征与 F1rst Motors Dubai 那辆车完全吻合；ANSA、Top Gear 等 2025 报道也独立将其描述为一次性 BP Green 签名车。不同来源对颜色命名不一致：类似工厂配置单的 Octane 页面写 GREEN JEWEL FYM.181037(X1)，迪拜经销商／媒体则称 BP Green，因此本站同时保留两种来源用词，不擅自合并为单一官方色名。公开里程也有矛盾：Octane 写 512 km，而 2025 迪拜报道约 629 km / 少于 400 miles；本站明确记录这一冲突，而不把其中一个数字强行当作连续里程时间线。",
      review_status:"2026-09-21 — 已交叉核验完整 VIN／底盘、类似工厂的个性化配置单、Charles Pozzi 保养历史，以及与迪拜 BP Green F1 签名车之间的同车身份；颜色命名与里程冲突均明确保留。"
    },
