...
(() => {
  const zhCommon = {
    ...
    "Octane Marketplace — chassis 291269 dealer listing":"Octane Marketplace — 底盘 291269 经销商挂牌",
    "ANSA — BP Green F1-signed Dubai listing":"ANSA — BP Green F1 车手签名迪拜挂牌",
    "Top Gear — BP Green F1-signed Dubai listing":"Top Gear — BP Green F1 车手签名迪拜挂牌",
    ...
    "Autoblog NL — Bernhard ten Brinke Daytona SP3 ownership report":"Autoblog NL — Bernhard ten Brinke Daytona SP3 车主报道",
  ...
  const zhRecords = {
    ...
    "SP3-BP-GREEN":{
      title:"BP Green — 迪拜 F1 车手签名车",
      country:"荷兰",
      city:"最新公开历史：经 Munsterhuis 进口；此前由迪拜 F1rst Motors 挂牌",
      market:"欧洲车辆 / 后续迪拜二手市场 / 据报道进口荷兰",
      owner:"私人车主；2025 年进口后报道为匿名荷兰车主",
      exterior:"F1rst Motors 与多家 2025 媒体描述的一次性 BP Green",
      interior:"F1rst Motors 经销商图库及后续荷兰报道均显示黑色座舱 / 黑色 Alcantara",
      wheels:"金色 / Oro 轮毂",
      calipers:"黑色；后续荷兰报道记录",
      mileage:"2025 迪拜经销商／媒体不同页面约记录 629–640 km",
      status:"据报道已从 Dubai 经 Munsterhuis 进口荷兰，交付匿名车主",
      sale:"迪拜挂牌阶段报道要价 AED 21,000,000",
      program:"Ferrari 个性化定制；未找到公开工厂 build sheet",
      options:["发动机盖由 Charles Leclerc 与 Carlos Sainz Jr. 以金色签名","一次性 BP Green 外观","金色 / Oro 轮毂","黑色刹车卡钳","黑色 Alcantara 座舱"],
      timeline:["2023 年 — Rapid Rides 后续报道该车最初交付德国 Renntrieb collection。","2024 年 — 据报道曾在 Concours d'Elegance Germany 展示。","2025 年 1–2 月 — 出现在迪拜 F1rst Motors，并以 AED 21 million 公开挂牌；不同来源记录约 629–640 km。","2025 年 11 月 — Rapid Rides 报道 Munsterhuis 从迪拜进口该车，交付一位匿名荷兰车主。"],
      notes:"这辆车不能再与底盘 291269 合并。两辆都是绿色 Daytona SP3，发动机盖也都有 Leclerc / Sainz 金色签名，但视觉配置存在关键差异：F1rst Motors 的 BP Green 车使用黑色座舱，公开经销商图库没有 16 号白色圆标；底盘 291269 Green Jewel 则有三个白色 16 号圆标与 Rosso Alcantara 红色座舱。因此本站已撤销此前错误合并。BP Green 车的完整 VIN 仍未在公开来源中确认。",
      review_status:"2026-09-21 — 经图片／配置重新核对后，与底盘 291269 重新拆分：黑色座舱／无 16 号圆标 vs 291269 的红色座舱／16 号圆标。BP Green 的 VIN 仍未确认。"
    },
    "SP3-291269-GREEN-JEWEL":{
      title:"Green Jewel 16 号 — 底盘 291269",
      edition:"原始 599 辆量产序列",
      country:"英国",
      city:"伦敦经销商挂牌；最初经 Charles Pozzi Paris 新车交付",
      market:"欧洲规格 / 英国经销商市场",
      owner:"私人车主",
      exterior:"GREEN JEWEL FYM.181037(X1) 四层 Extra-Range 车漆，搭配三个 Bianco Cervino 白色圆标及 Nero DS 16 号",
      interior:"Alcantara Rosso FX 3694，Nero Alcantara 方向盘握把",
      wheels:"金色锻造轮毂",
      calipers:"亮黑色",
      mileage:"经销商挂牌时 512 km；2024 Charles Pozzi 年度保养时 501 km",
      status:"Jeremy Cottingham 标记为已售；同步经销商挂牌仍有公开存档",
      sale:"价格未公开；Jeremy Cottingham 页面标记 SOLD",
      program:"Ferrari Atelier / Extra-Range",
      options:["GREEN JEWEL FYM.181037(X1) 特殊四层车漆","三个 Bianco Cervino 2005001 白色圆标，内部为 Nero DS 205500 的 16 号","发动机盖由 Charles Leclerc 与 Carlos Sainz Jr. 以金色签名","三圆形 Historic / Vintage 涂装","气刷 Scuderia Ferrari 盾徽","亮黑色刹车卡钳","金色锻造轮毂","碳纤维硬顶","碳纤维车身下部","碳纤维后盖唇边","Alcantara Rosso FX 3694 内饰","Nero Alcantara 方向盘握把","黑色 Alcantara 门把手","黑色四点式安全带","Apple CarPlay","前轴升降","头枕 Cavallino 使用特殊 70268 缝线","大号座垫 / L32 靠背","Racing Driver Set","Extra-Range 外观、内饰与脚垫"],
      timeline:["2023 年 — 经 Charles Pozzi Paris 新车交付。","2024 年 — Charles Pozzi Paris 年度保养，记录 501 km。","后续经销商市场阶段 — Jeremy Cottingham 以 512 km 挂牌；当前页面标记为 previously sold。","2026 年 — Octane Marketplace 与 Classic Driver 同步公开同一 VIN、512 km 与详细个性化配置。"],
      notes:"这是与迪拜 F1rst Motors BP Green 不同的另一辆绿色 F1 签名 Daytona SP3。底盘 291269 可以通过三个白色 16 号圆标和 Rosso Alcantara 红色座舱明确识别；迪拜 BP Green 车则是黑色座舱，公开图库中没有 16 号圆标。Octane、Jeremy Cottingham 与 Classic Driver 都公开 VIN ZFF05UMB000291269、512 km、Charles Pozzi 历史和同一套 Ferrari Atelier 详细配置。",
      review_status:"2026-09-21 — 已交叉核验完整 VIN、512 km、Charles Pozzi 保养历史、Atelier 配置及 15 张独立经销商图库；明确与另一辆 Dubai BP Green 分列。",
      photo_captions:["Green Jewel 16 号 · 左前 3/4","右后 3/4 · 16 号圆标","开放车顶侧面 · 可见 Rosso 座舱","硬顶侧面 · 16 号","高位左前 3/4 · 开放车顶","影棚侧面 · 安装硬顶","正后方 · 横向尾部造型","正前方 · Green Jewel 四层车漆","开放车顶侧面","正前方开灯 · 可见 Rosso 座舱","车门开启 · Rosso Alcantara 座舱","硬顶侧面","俯视 · 安装硬顶","俯视 · 开放 Rosso 座舱","俯视细节 · Rosso Alcantara 座椅与四点式安全带"]
    },
...
,
    ...
    "SP3-277498-DEMO-LEAD":{
      ...
      exterior:"Rosso Magma",
      interior:"Blu",
      wheels:"公开照片可见银灰色五辐轮毂",
      status:"工厂 Demo / 公开活动车辆",
      program:"工厂 Demo",
      options:["Rosso Magma 外观","Blu 蓝色座舱","记录中的意大利车牌 GJ-562-FL"],
      timeline:["2022 年 7 月 — VIN 逐车页记录底盘 277498 在 Zandvoort，使用意大利车牌 GJ-562-FL，并公开多角度图集。"],
      notes:"Dutch Ferrari and Lamborghini Register 公开完整 VIN ZFF05UMB000277498、2022 年份、Rosso Magma / Blu 配置及意大利车牌 GJ-562-FL，并将其描述为从未在荷兰注册的 factory demo car。VIN 逐车页进一步记录同一辆车 2022 年 7 月在 Zandvoort 的实车图。该证据足以形成详细 demo profile，但不能据此判断该底盘后来是否计入、转换为或一直独立于 599 辆客户配额。",
      review_status:"2026-09-22 — 已复核完整 VIN、factory-demo 分类、意大利车牌、Rosso Magma / Blu 配置及 Zandvoort 图集；客户配额归属仍未确定。",
      photo_captions:["2022 Zandvoort · Blu 内饰","2022 Zandvoort · 车尾 · GJ-562-FL","2022 Zandvoort · 侧面","2022 Zandvoort · 前 3/4","2022 Zandvoort · 另一前 3/4"]
    },
    "SP3-277499-DEMO-LEAD":{
      title:"Ferrari 工厂 Demo — Giallo Triplo Strato / Rosso — 底盘 277499",
      edition:"工厂 Demo；客户配额归属尚未确定",
      country:"意大利",
      city:"荷兰 Zandvoort",
      market:"工厂 Demo / 意大利车牌",
      owner:"Ferrari 工厂 Demo 车队（registry 来源报告）",
      exterior:"Giallo Triplo Strato",
      interior:"Rosso",
      wheels:"公开照片可见银灰色五辐轮毂",
      calipers:"公开照片可见红色刹车卡钳",
      status:"工厂 Demo / 公开活动车辆",
      program:"工厂 Demo",
      options:["Giallo Triplo Strato 外观","Rosso 红色座舱","记录中的意大利车牌 GJ-563-FL"],
      timeline:["2022 年 7 月 — VIN 逐车页记录底盘 277499 在 Zandvoort，使用意大利车牌 GJ-563-FL，并公开 6 张照片，其中一张直接可见 VIN 标记。"],
      notes:"Dutch Ferrari and Lamborghini Register 公开完整 VIN ZFF05UMB000277499、2022 年份、Giallo Triplo Strato / Rosso 配置及意大利车牌 GJ-563-FL，并将其描述为从未在荷兰注册的 factory demo car。Zandvoort 图集中既有 VIN 标记，也有外观与座舱视角。与 277497、277498 一样，客户配额归属不作推断。",
      review_status:"2026-09-22 — 已复核完整 VIN、factory-demo 分类、意大利车牌、Giallo Triplo Strato / Rosso 配置及 6 张 Zandvoort 图片；客户配额归属仍未确定。",
      photo_captions:["2022 Zandvoort · 可见 VIN ZFF05UMB000277499","2022 Zandvoort · Rosso 内饰","2022 Zandvoort · 车尾 · GJ-563-FL","2022 Zandvoort · 前 3/4","2022 Zandvoort · 另一前 3/4","2022 Zandvoort · 外观；背景可见底盘 277498"]
    },
    "SP3-289571-VIN-LEAD":{
  ...
  function value(record, key, target=lang()) {
    ...
    if (key === "credits") return (record.photos||[]).map(v=>common(typeof v === "string" ? "" : (v?.credit||""), target));
